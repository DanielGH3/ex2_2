...
TEST_CASE("1.Wins/losses count correctly") {
    Player p1("Alice");
    Player p2("Bob");
    Game game(p1, p2); 
    game.playAll();
    game.playAgain();
    game.playAll();
    CHECK(p1.wins + p2.wins + p1.losses + p2.losses == 4);
}
...
TEST_CASE("18.Win/loss counting works with more players") {
    ...
    Game game2(p2, p3); 
    game2.playAll();
    CHECK(p1.wins + p1.losses + p2.wins + p2.losses + p3.wins + p3.losses == 4);
}
